...
public class CustomerServiceImpl implements CustomerService {
  ...
  public CustomerDto findCustomerById(Long id) {
	...
	/* (non-Javadoc)
   * @see cat.grc.spring.data.service.CustomerService#addCustomer(cat.grc.spring.data.dto.CustomerDto)
   */
	@Override
  public CustomerDto addCustomer(CustomerDto customer) {
	...
	/* (non-Javadoc)
   * @see cat.grc.spring.data.service.CustomerService#updateCustomer(cat.grc.spring.data.dto.CustomerDto)
   */
	@Override
  ...
  public void deleteCustomer(Long id) {
	...
	/* (non-Javadoc)
   * @see cat.grc.spring.data.service.CustomerService#findAllAccountsByCustomerId(java.lang.Long, int, int)
   */
	@Override
  public Collection<AccountDto> findAllAccountsByCustomerId(Long customerId, int page, int size) {
		...
		return accountsPage.getContent().stream().map(account -> AccountMapper.toDto(account))
				.collect(Collectors.toList());
	}
  ...
  public AccountDto addAccount(AccountDto account) {
	...
	/* (non-Javadoc)
   * @see cat.grc.spring.data.service.CustomerService#updateAccount(cat.grc.spring.data.dto.AccountDto)
   */
	@Override
