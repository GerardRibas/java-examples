...
public class ProductControllerTestIT {
  ...
  public void testGetProductsPageAndSizeNoDefault() {
    ResponseEntity<ProductDto[]> responseEntity =
        restTemplate.getForEntity(CONTROLLER_URL + "?page=1&size=3", ProductDto[].class);
    ProductDto[] products = responseEntity.getBody();
    assertEquals(responseEntity.getStatusCode(), HttpStatus.OK);
  ...
  public void testCreateProduct() {
    ...
    ProductDto product = new ProductDto(null, null, category, "lacinia. Sed congue, elit sed", new BigDecimal("9.458"),
        null, null,
  ...
  @Test
  public void testCreateProduct_ResourceAlreadyExistsException()
  ...
  public void testGetProduct() {
    ResponseEntity<ProductDto> responseEntity = restTemplate.getForEntity(CONTROLLER_URL + "/1", ProductDto.class);
    ProductCategoryDto category = new ProductCategoryDto(6L, "Cameras & Optics", new Float("0.2"));
    ProductDto expectedProduct = new ProductDto(1L, null, category, "lacinia. Sed congue, elit sed",
        new BigDecimal("9.458"), null, null,
        "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Curabitur sed tortor. Integer aliquam adipiscing lacus. Ut nec");
  ...
  public void testUpdateProduct() {
    ProductCategoryDto category = new ProductCategoryDto(6L, "Cameras & Optics", new Float("0.2"));
    ProductDto product = new ProductDto(19L, null, category, "Some Product Name", new BigDecimal("10.458"), "Blue",
        "10x10", "Some Product Description");
    restTemplate.put(CONTROLLER_URL + "/19", product);
    ResponseEntity<ProductDto> savedProduct = restTemplate.getForEntity(CONTROLLER_URL + "/19", ProductDto.class);
  ...
  public void testUpdateProduct_ResourceNotFoundException()
      throws JsonParseException, JsonMappingException, IOException {
    ProductCategoryDto category = new ProductCategoryDto(6L, "Cameras & Optics", new Float("0.2"));
    ProductDto product = new ProductDto(9999L, null, category, "lacinia. Sed congue, elit sed", new BigDecimal("9.458"),
        null, null,
        "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Curabitur sed tortor. Integer aliquam adipiscing lacus. Ut nec");
    try {
