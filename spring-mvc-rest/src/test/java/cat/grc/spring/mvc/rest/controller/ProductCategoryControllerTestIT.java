...
public class ProductCategoryControllerTestIT {
	...
	public void testGetProducts() {
		ResponseEntity<ProductCategoryDto[]> responseEntity = restTemplate.getForEntity(CONTROLLER_URL,
	...
	public void testCreateProductCategory() {
		...
		ResponseEntity<ProductCategoryDto> response = restTemplate.postForEntity(CONTROLLER_URL, category,
				ProductCategoryDto.class);
	...
	public void testGetProductCategory() {
		ResponseEntity<ProductCategoryDto> responseEntity = restTemplate.getForEntity(CONTROLLER_URL + "/1",
				ProductCategoryDto.class);
	...
	public void testUpdateProductCategory() {
		...
		ResponseEntity<ProductCategoryDto> responseEntity = restTemplate.getForEntity(CONTROLLER_URL + "/8",
				ProductCategoryDto.class);
	...
	@Test
	public void testDeleteCategory_ResourceNotFoundException() throws JsonParseException, JsonMappingException, IOException {
		try {
	...
	@Test
	public void testDeleteCategory_ProductCategoryHasProductsException() throws JsonParseException, JsonMappingException, IOException {
		try {
	...
	@Test
	  public void testGetProductsInCategory() throws Exception {
		ResponseEntity<ProductDto[]> responseEntity = restTemplate.getForEntity(CONTROLLER_URL+ "/1/products",
				ProductDto[].class);
